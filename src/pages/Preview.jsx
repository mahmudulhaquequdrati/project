...
export default function Preview({ dynamicData }) {
  ...
  return (
    <div className="p-4 ">
      <div className=" flex gap-6 items-center">
        <div className="">
          {dynamicData?.imageUrl || data?.imageUrl ? (
            <img
              className="w-32 "
              src={dynamicData?.imageUrl || data?.imageUrl}
            />
          ) : (
            <img
              className="w-32 "
        ...
        <div className="text-gray-700">
          <h2 className="text-blue-700 font-medium">
            {dynamicData?.name ? dynamicData?.name : data?.name} | Better Tax
            Releif
          </h2>
          <h3 className="py-1 text-sm font-medium">
            {dynamicData?.title ? dynamicData?.title : data?.title}
          </h3>
          <div className="flex gap-2 ">
            <p className="flex items-center gap-1 cursor-pointer text-sm">
              ...
              {dynamicData?.phone ? dynamicData?.phone : data?.phone}
            </p>
          ...
          <p className="flex gap-1 text-[15px] mt-0.5">
            ...
            {dynamicData?.email ? dynamicData?.email : data?.email}
            @bettertaxrelief.com
          </p>
          <p className="flex gap-1 text-[15px] mt-0.5">
            <svg
      ...
      <img
        src={"https://i.postimg.cc/cH1g53qN/ba-6.png"}
        className="w-[40%]  mt-6"
        alt=""
      />
